...
- **From [GitHub Releases (`v1.0.3`)](https://github.com/dreamfarer-space/obsidian-mermaid-boost/releases/tag/1.0.3)**: Download `mermaid-boost-1.0.3.zip` and extract its files into `<Vault>/.obsidian/plugins/mermaid-boost/`, or download `manifest.json`, `main.js`, and `styles.css` individually and copy them into that folder.
...
| `manifest.json` | Obsidian plugin manifest metadata (`1.0.3`, `minAppVersion: 1.5.0`) |
