...
- **从 [GitHub Releases (`v1.0.5`)](https://github.com/dreamfarer-space/obsidian-mermaid-boost/releases/tag/1.0.5) 下载**：下载 `mermaid-boost-1.0.5.zip` 并将其中的文件解压到 `<Vault>/.obsidian/plugins/mermaid-boost/`，或单独下载 `manifest.json`、`main.js`、`styles.css` 并复制到该目录。
...
| `manifest.json` | Obsidian 插件清单元数据（`1.0.5`，`minAppVersion: 1.5.0`） |
